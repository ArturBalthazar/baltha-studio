...
const textSegments = [
    "Whether it's integrating tools into an existing web ecosystem, ",
    "building custom web applications and data visualizations, ",
    "or creating entire virtual worlds, I've got it covered! Ready to start?"
];
